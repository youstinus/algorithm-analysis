...
namespace MergeSortD
{
    class Program
    {
        ...
        private static bool TestArrayFromFile(string filename, int count)
        {
            var numbers = ReadFile(filename);
            var dataArray = new DataArray(numbers);
            Console.WriteLine("\n Merge sort against Array inside Disk. Data from file \n");
        ...
        private static bool TestListFromFile(string filename, int count)
        {
            var numbers = ReadFile(filename);
            var dataList = new DataList(numbers);
            Console.WriteLine("\n Merge sort against LinkedList inside Disk. Data from file \n");
        ...
        private static bool TestArray(int n, int seed, int count)
        {
            ...
            Console.WriteLine("\n Merge sort against Array inside Disk. Data generated \n");
            dataArray.Print(count);
            //dataArray.PrintFromTo(5, 15);
        ...
        private static bool TestList(int n, int seed, int count)
        {
            ...
            Console.WriteLine("\n Merge sort against LinkedList inside Disk. Data generated \n");
            dataList.Print(count);
            //dataList.PrintFromTo(5, 15);
