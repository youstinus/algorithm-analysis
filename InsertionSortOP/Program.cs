...
namespace InsertionSortOP
{
    class Program
    {
        ...
        private static bool TestArrayFromFile(string path, int count)
        {
            ...
            Console.WriteLine("\n Insertion sort against Array inside RAM. Data from file \n");
        ...
        private static bool TestListFromFile(string path, int count)
        {
            ...
            Console.WriteLine("\n Insertion sort against LinkedList inside RAM. Data from file \n");
        ...
        private static bool TestArray(int n, int seed, int count)
        {
            ...
            Console.WriteLine("\n Insertion sort against Array inside RAM. Data generated \n");
            dataArray.Print(count);
            //dataArray.PrintFromTo(5, 15);
        ...
        private static bool TestList(int n, int seed, int count)
        {
            ...
            Console.WriteLine("\n Insertion sort against LinkedList inside RAM. Data generated \n");
            dataList.Print(count);
            //dataList.PrintFromTo(5, 15);
